<?php 
  ...
  if (isset($_POST['updatestudent'])) {
  	...
  	$query = "UPDATE student SET name='$name', lastname='$lastname', age='$age', degree='$degree' WHERE id= $id";
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
     ...
     <li class="breadcrumb-item" aria-current="page"><a href="dashboard-index.php?page=all-student">All Student </a></li>
  </ol>
</nav>
